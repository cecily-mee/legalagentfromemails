...
2. Use the following rules to assign the correct category based on all available text and image content:
   - **product_enquiry**: When the email or attachments seek information about a product feature, benefit, service, or pricing.
   - **customer_complaint**: When the email or attachments communicate dissatisfaction or a complaint.
   - **customer_feedback**: When the email or attachments provide feedback or suggestions regarding a product or service.
...
2. Identify the main intent or problem expressed across all content.
